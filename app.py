...
h1{font-family:'Bebas Neue',sans-serif;font-size:2rem;letter-spacing:3px;
  color:#E50914;margin-bottom:6px}
.sub{color:#aaa;font-size:.85rem;margin-bottom:28px}
.row{display:flex;justify-content:space-between;padding:10px 0;
  border-bottom:1px solid #2a2a2a;font-size:.95rem}
.row span:last-child{color:#E50914;font-weight:700}
.total-row{display:flex;justify-content:space-between;padding:14px 0;
  font-size:1.1rem;font-weight:800}
.total-row span:last-child{color:#46d369;font-size:1.2rem}
...
<div class="box">
  ...
  <div class="row"><span>📦 Total pedidos borrados</span><span>%d</span></div>
  <div class="row"><span>🚀 Enviados</span><span>%d</span></div>
  <div class="row"><span>❌ Cancelados</span><span>%d</span></div>
  <div class="total-row"><span>💰 Ingresos del mes</span><span>₡ %s</span></div>
  <div class="ok">✅ Base de datos limpia — El dueño empieza el mes desde cero</div>
  <p class="fecha">Reseteo realizado: %s</p>
  <a href="/admin">Ir al Panel Admin</a>
</div>
</body></html>""" % (total_peds, total_enviados, total_cancelados,
                    "{:,.0f}".format(total_ingresos), fecha)
